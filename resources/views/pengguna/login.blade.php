...
<head>
    ...
    <link href="{{ asset('asset/dist/css/tabler-vendors.min.css') }}" rel="stylesheet" />
...
<body class=" d-flex flex-column bg-white">
    ...
    <div class="row g-0 flex-fill">
            ...
            <div class="container container-tight my-5 px-lg-5">
                <div class="text-center mb-4">
                    <a href="." class="navbar-brand navbar-brand-autodark"><img
                            src="{{ asset('assets/static/LOGO.PNG') }}" height="36" alt=""></a>
                </div>
        ...
        <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
            <!-- Photo -->
            <div class="bg-cover h-100 min-vh-100" style="background-image: url(./assets/static/photos/gedung.jpg)">
            </div>
        </div>
    </div>
    <!-- Libs JS -->
