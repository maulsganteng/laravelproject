...
<body class=" d-flex flex-column">
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="{{ route('simpanregistrasi') }}" method="post" autocomplete="off"
                novalidate>
                {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="form-footer">
                        <a href="{{ route('simpanregistrasi') }}"class="btn btn-primary w-100">register</a>
                    </div>
                </div>
            </form>
